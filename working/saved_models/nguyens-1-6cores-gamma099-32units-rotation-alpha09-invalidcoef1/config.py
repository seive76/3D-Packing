...
gamma = 0.99 # discount factor for rewards (default: 1)
num_processes = int(6) # how many training CPU processes to use (default: 16)
entropy_coef = 0.01 # entropy term coefficient (default: 0.01)
invalid_coef = 0.1 # invalid action possibility term coefficient (default: 0.1)
value_loss_coef = 0.5 # value loss coefficient (default: 0.5)
hidden_size = 32 # hidden layer cell number (default: 256)
...
box_range = (2, 2, 2, 2, 2, 2) # the item size range (x_min, y_min, z_min, x_max, y_max, z_max)
...
enable_rotation = True # whether agent can rotate box
...
device = "mps" # which device to use (default: 0)
...
lr = 1e-5    # learning rate (default: 7e-4)
eps = 1e-5 # RMSprop optimizer epsilon (default: 1e-5)
alpha = 0.9 # RMSprop optimizer apha (default: 0.99)
max_grad_norm = 0.5 # max norm of gradients (default: 0.5)
seed = int(42) # random seed (default: 1)
num_steps = int(5) # number of forward steps in A2C (default: 5)
num_env_steps = 1e6 # number of environment steps to train (default: 10e6)
