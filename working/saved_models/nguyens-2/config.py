...
gamma = 0.95 # discount factor for rewards (default: 1)
num_processes = int(4) # how many training CPU processes to use (default: 16)
...
hidden_size = 64 # hidden layer cell number (default: 256)
...
box_size_set = []
for i in range(box_range[0],box_range[3]):
    for j in range(box_range[1],box_range[4]):
        for k in range(box_range[2],box_range[5]):
