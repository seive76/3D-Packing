...
class Dimension:
    ...
    def __str__(self):
        return (
            f"Dimension(width={self.width}, height={self.height}, " #depth={self.depth}, 
...
class Coordinate:
    ...
    def from_blb_to_vertices(self, dims):
        ...
        tlb = Coordinate(self.x, self.y + dims.depth, self.z + dims.height)
        tlf = Coordinate(self.x + dims.width, self.y, self.z + dims.height)
        trb = Coordinate(self.x + dims.width, self.y + dims.depth, self.z + dims.height)
...
class Vertices:
    ...
    def __init__(self, blb, dims):
        ...
        self.tlb = Coordinate(self.blb.x, self.blb.y + self.dims.depth, self.blb.z + self.dims.height)
        self.tlf = Coordinate(
        ...
        self.trb = Coordinate(
            self.blb.x + self.dims.width, self.blb.y + self.dims.depth, self.blb.z + self.dims.height
        )
        self.trf = Coordinate(
